...
markChallengeAsInprogressController.post(
  ...
  createMiddleware<Env>(async (context, next) => {
    ...
    context.set(
      "markChallengeAsInprogressUseCase",
      new MarkChallengeAsInprogressUseCase(challengeRepository),
    );
  ...
  async (context) => {
    ...
    const payload =
      await context.var.markChallengeAsInprogressUseCase.invoke(body);
